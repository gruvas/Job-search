...
const Registration = () => {
	...
	const registerHandler = async () => {
		try {
			...
			alert(
				'Необходимо заполнить все поля и придумать пароль не меньше 6 символов. Может быть данный email уже зарегистрирован.'
			)
		}
	}
	...
	return (
		<div className='registration'>
			...
			<div className='registration_password'>
				<input
					className='registration_password_input'
					type={typePassword}
					placeholder='Пароль'
					id='password'
					name='password'
				...
				/>
				<button
					className='registration_password_btn'
					onClick={() => setTypePassword(DisplayPassword(typePassword))}
				>
					<img
						className='registration_password_btn_img'
						src={eye}
						alt=''
					/>
				</button>
