...
const JobCreation = () => {
    ...
    function submitting_job() {
        ...
        data_vacancy.name_organization !== '' && data_vacancy.name !== '' && data_vacancy.contacts !== '') {
            ...
            alert('Необходимо заполнить все поля и выбрать тип занятости, и опыт работы')
        }
    }
    ...
    return (
        <div className='job_creation'>
            ...
            <div className="job_creation_indent">
                ...
                id='name' name='name' 
                onChange={changeHandler} maxLength={100}/>
            </div>
            
            <div className="job_creation_indent">
                <p className="filling_resume_name">Наименование организации</p>
                <input type="text" className="filling_resume_input"  
                id='name_organization' name='name_organization' 
                onChange={changeHandler} maxLength={100}/>
            </div>
            ...
            <div className="job_creation_indent">
                ...
                id='salary' name='salary' onChange={changeHandler}
                onKeyPress={SalaryValidation}  maxLength={15}/>
            </div>
           
            <div className="job_creation_indent dropdown_block" onClick={() => setOpen1(!isOpen1)}>
                ...
                isOpen1 && (
                    <>
                        <div className='dropdown_menu'>
                            <div className='dropdown_menu_text' onClick={() => {setExperience('Не имеет значения'); setOpen1(false)}}>Не имеет значения</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text' onClick={() => {setExperience('Нет опыта'); setOpen1(false)}}>Нет опыта</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text'  onClick={() => {setExperience('От 1 года до 3 лет'); setOpen1(false)}}>От 1 года до 3 лет</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text'  onClick={() => {setExperience('От 3 до 6 лет'); setOpen1(false)}}>От 3 до 6 лет</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text'  onClick={() => {setExperience('Более 6 лет'); setOpen1(false)}}>Более 6 лет</div>
                        </div>
                    </>
                )
            }

            <div className="job_creation_indent dropdown_block" onClick={() => setOpen2(!isOpen2)}>
...

            {
                isOpen2 && (
                    <>
                        <div className='dropdown_menu'>
                            <div className='dropdown_menu_text' onClick={() => {setEmployment('Стажировка'); setOpen2(false)}}>Стажировка</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text'  onClick={() => {setEmployment('Полная занятость'); setOpen2(false)}}>Полная занятость</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text' onClick={() => {setEmployment('Проектная работа'); setOpen2(false)}}>Проектная работа</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text'  onClick={() => {setEmployment('Частичная занятость'); setOpen2(false)}}>Частичная занятость</div>
                            <hr className='dropdown_menu_hr'/>
                            <div className='dropdown_menu_text'  onClick={() => {setEmployment('Волонтерство'); setOpen2(false)}}>Волонтерство</div>
                        </div>
                    </>
                )
            }
            ...
            <button className="job_creation_btn" onClick={submitting_job}>Создать вакансию</button>
